        ...
        <div className="bg-white rounded-lg w-80 sm:w-1/2 md:w-2/3 lg:w-1/2">
          <div className="flex flex-col items-start p-4 full m">
            ...
            <div className="ml-auto mt-4">
              ...
              <button className="focus:outline-none bg-transparent hover:bg-gray-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded">
                Still Shopping
              </button>
            </div>
          </div>
